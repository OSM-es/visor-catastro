...
api.add_resource(resources.Fixme, '/fixme/<int:id>')
api.add_resource(resources.Municipalities, '/municipalities')
api.add_resource(resources.Municipality, '/municipality/<string:code>')
api.add_resource(resources.Provinces, '/provinces')
api.add_resource(resources.Streets, '/task/<int:id>/street/<string:cat_name>', '/task/<int:id>/street/')
